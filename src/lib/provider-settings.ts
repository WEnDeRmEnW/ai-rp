...
export const providerDefaults: Record<ProviderKind, PersistentProviderConfig> = {
  ...
  ollama: { provider: 'ollama', model: 'deepseek-v4-flash:cloud', baseUrl: 'https://ollama.com/v1', temperature: 0.85 },
...
export function loadProviderConfig(): ProviderConfig {
  try {
    ...
    const base = persistent?.provider ? persistent : providerDefaults.demo
