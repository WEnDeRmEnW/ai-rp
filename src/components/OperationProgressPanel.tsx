...
const stageLabels: Record<string, string> = {
  ...
  'idea-seed': 'Необычная основа',
  'idea-critic': 'Проверка оригинальности',
  'idea-rewrite': 'Пересборка идеи',
  'idea-verification': 'Финальная проверка',
  'idea-ready': 'Концепция готова',
