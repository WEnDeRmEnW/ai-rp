...
export function demoWorld(input: WorldGenerationRequest): GeneratedWorld {
  ...
  return {
    ...
    world: {
      ...
      factions: [
        {
          name: 'Хранители порядка', kind: 'government', description: 'Защищают существующее устройство мира, даже когда оно перестаёт быть справедливым.', attitude: 'Наблюдают за героем',
        ...
        {
          name: 'Союз новой зари', kind: 'movement', description: 'Разрозненные люди, желающие изменить правила.', attitude: 'Ищут способ довериться герою',
        ...
        {
          name: 'Дом Латунного пути', kind: 'guild', description: 'Союз перевозчиков и мастеров, обслуживающий дороги между печатями.', attitude: 'Оценивают надёжность героя',
        ...
        {
          name: 'Конклав пустого знака', kind: 'institution', description: 'Закрытая школа исследователей, изучающая исчезающие имена и сломанные печати.', attitude: 'Считают героя возможным ключом',
