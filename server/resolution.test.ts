...
describe('token-efficient action checks', () => {
  ...
  it('respects mythic threat mechanics and materially rewards an established defeat condition', () => {
    ...
    npc.threatProfile = {
      tier: 'mythic', scope: 'Один город и его врата.', reputation: 'Не проигрывал внутри области клятвы.', powerBasis: 'Древняя клятва связала его с геометрией всех путей города.', combatIdentity: 'Не преследует цель напрямую, а перестраивает пространство, пока любой маршрут не приводит к выгодной ему позиции.',
      signatureAbilities: ['Власть над порогом', 'Замкнутый исход', 'Возврат к вратам'], threatVectors: ['Замыкает пути.', 'Разделяет отряд.', 'Перенаправляет атаки.', 'Изолирует ресурсы.'], defensiveLayers: ['Возвращает прямое воздействие к порогу.', 'Переносит повреждение в якорь клятвы.'],
      battlefieldControl: ['Меняет связность улиц и ворот.'], informationAdvantages: ['Чувствует пересечение каждого порога.'], preparedAssets: ['Якорь клятвы под центральными вратами.'], collateralRisks: ['Разрыв якоря способен обрушить часть городской сети путей.'],
      engagementPhases: [
        { name: 'Замыкание', trigger: 'Противник пересекает внешний порог.', doctrine: 'Разделить пути и изучить способ движения.', priorities: ['Изолировать героев.'], signatureMoves: ['Возврат к вратам'], openings: ['Внешние пороги на миг остаются неподвижны после переноса.'], exitConditions: ['Разрушен внешний контур.'] },
        { name: 'Сжатие', trigger: 'Внешний контур разрушен.', doctrine: 'Сжать доступное пространство вокруг якоря.', priorities: ['Защитить якорь.'], signatureMoves: ['Замкнутый исход'], openings: ['Дальний контроль ослабевает у самого якоря.'], exitConditions: ['Якорь найден.'] },
        { name: 'Последняя клятва', trigger: 'Якорь подвергся прямой атаке.', doctrine: 'Перенести остаток силы в защиту одного порога.', priorities: ['Не допустить разрушения якоря.'], signatureMoves: ['Власть над порогом'], openings: ['Остальные пути перестают перестраиваться.'], exitConditions: ['Якорь разрушен или противник отступил.'] },
      ],
      whyDangerous: ['Контролирует само пространство пути.', 'Лишает противника устойчивой позиции.', 'Меняет доктрину при разрушении каждого контура.'], knownFeats: ['Остановил исход целого народа.', 'Замкнул вторжение внутри одного квартала.'],
      constraints: ['Не действует вне города.', 'Сила зависит от физического якоря.'], defeatRequirements: ['Разрушить якорь клятвы.', 'Добраться до центрального порога, пока дальний контроль ослаблен.'], escalationTriggers: ['Нападение на город.'], visibility: 'known',
    }
