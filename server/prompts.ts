...
function compactCampaign(campaign: Campaign, input: string) {
  ...
  return {
    ...
    presentNpcs,
    party,
    npcDirectory: campaign.npcs.map(({ id, name, role, description, personality, disposition, status, currentGoal, lastSeen, notes, relationship, relationshipDimensions, initiative, strategy, recruitment, threatProfile, voice, knowledge, stats, resources, statusEffects, abilities }) => ({ id, name, role, description, personality, disposition, status, currentGoal, lastSeen, notes, relationship, relationshipDimensions, initiative, strategy, recruitment, threatProfile, voice, knowledge, stats, resources, statusEffects, abilities })),
