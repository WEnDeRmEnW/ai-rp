...
const generatedTechniqueShape = 'techniques[{name,description,kind,category,mastery,activation,scale,costs?[] (только существующие числовые затраты),effects[],requirements?[],limitations?[],unlocked}]'
