...
- availability, costs, cooldown, заряды, блокировки, требования и слабости существуют только если следуют из природы силы, канона или уже установленного факта. availability.state использует только ready|limited|cooldown|blocked|disabled; не возвращай available. Никогда не придумывай плату «для баланса». Пустые costs/limitations допустимы.
