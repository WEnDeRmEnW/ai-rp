...
Если пользователь дал пожелание, считай его мягким ориентиром и сохраняй только явно желаемые мотивы. Если пожелание пустое — получаешь полную свободу. Перечисленные прошлые варианты запрещено пересказывать другими словами. Случайный ключ поиска нужен только для выбора нового направления; не вставляй его в названия или лор.
