...
Сначала зафиксируй независимые правила и систему возможностей всего общества, и только затем полностью проработай героя, его реальные способности, ресурсы и стартовые предметы/артефакты. Группы capabilitySystem не должны быть перечнем способностей героя. Ничего не сокращай: этот этап владеет окончательными полями player и inventory.`,
